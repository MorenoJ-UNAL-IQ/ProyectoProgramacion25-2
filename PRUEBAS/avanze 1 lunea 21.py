...
reglas_rect = boton_de_reglas.get_rect(topleft=(100, 500))           
...
#de casillas que tocan la x central
    ...
    class ficha :
        def __init__ (self, color1, color2, color3, x, y):
            self.color1 = color1 
            self.color2 = color2
            self.color3 = color3
            self.x = x
        ...
        def dibujar(self, screen, colores):
            pygame.draw.circle(screen, colores[self.color1], (self.x, self.y), 20)
            pygame.draw.circle(screen, colores[self.color2], (self.x, self.y), 15)
            pygame.draw.circle(screen, colores[self.color3], (self.x, self.y), 10)

    #FICHAS ROJAS
    ficha_roja1 = ficha("RED", "REED", "RED", 75, 675)
